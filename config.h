...
static struct key keys[] = {
    ...
    {MOD|XK_Control_L,           XK_1, ws_go,     {.i = 11}},
    {MOD|XK_Control_L|ShiftMask, XK_1, win_to_ws, {.i = 11}},
    {MOD|XK_Control_L,           XK_2, ws_go,     {.i = 12}},
    {MOD|XK_Control_L|ShiftMask, XK_2, win_to_ws, {.i = 12}},
    {MOD|XK_Control_L,           XK_3, ws_go,     {.i = 13}},
    {MOD|XK_Control_L|ShiftMask, XK_3, win_to_ws, {.i = 13}},
    {MOD|XK_Control_L,           XK_4, ws_go,     {.i = 14}},
    {MOD|XK_Control_L|ShiftMask, XK_4, win_to_ws, {.i = 14}},
    {MOD|XK_Control_L,           XK_5, ws_go,     {.i = 15}},
    {MOD|XK_Control_L|ShiftMask, XK_5, win_to_ws, {.i = 15}},
    {MOD|XK_Control_L,           XK_6, ws_go,     {.i = 16}},
    {MOD|XK_Control_L|ShiftMask, XK_6, win_to_ws, {.i = 16}},
    {MOD|XK_Control_L,           XK_7, ws_go,     {.i = 17}},
    {MOD|XK_Control_L|ShiftMask, XK_7, win_to_ws, {.i = 17}},
    {MOD|XK_Control_L,           XK_8, ws_go,     {.i = 18}},
    {MOD|XK_Control_L|ShiftMask, XK_8, win_to_ws, {.i = 18}},
    {MOD|XK_Control_L,           XK_9, ws_go,     {.i = 19}},
    {MOD|XK_Control_L|ShiftMask, XK_9, win_to_ws, {.i = 19}},
    {MOD|XK_Control_L,           XK_0, ws_go,     {.i = 20}},
    {MOD|XK_Control_L|ShiftMask, XK_0, win_to_ws, {.i = 20}},
